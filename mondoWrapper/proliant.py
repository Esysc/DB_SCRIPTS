...
host = '10.0.139.2'
iLO_loginname = 'administrator'
iLO_password = '***REMOVED***'
bios_password = None
...
print "iloHstonema: %s" % host
print " ilologin: %s" % iLO_loginname
print " ilo_passwordis: %s" % iLO_password
